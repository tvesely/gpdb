...
/* gp_tablespace_version_directory_name() => text */
DATA(insert OID = 5052 ( gp_tablespace_version_directory_name  PGNSP PGUID 12 1 0 0 0 f f f f t f s 0 0 25 "" _null_ _null_ _null_ _null_ gp_tablespace_version_directory_name _null_ _null_ _null_ n a ));
DESCR("Get tablespace version directory name");
