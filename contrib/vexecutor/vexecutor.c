...
_PG_init(void)
{
	...
	DefineCustomBoolVariable("vectorized_executor_enable",
	                         ...
	                         NULL,
	                         &vmthd.vectorized_executor_enable, /* valueAddr */
	                         false,  /* bootValue */
	                         PGC_USERSET, /* context */
	                         0, /* flags */
...
#define HAS_EXECUTOR_MEMORY_ACCOUNT(planNode, NodeType) \
	(NULL != planNode->memoryAccountId && \
	MEMORY_OWNER_TYPE_Exec_##NodeType == planNode->memoryAccountId->ownerType)
...
//				if(HAS_EXECUTOR_MEMORY_ACCOUNT(plan, TableScan))
					START_MEMORY_ACCOUNT(plan->memoryAccountId);
